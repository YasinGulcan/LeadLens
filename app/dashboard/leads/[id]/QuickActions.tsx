...
/** Lead detay sağ sütunundaki "Hızlı Aksiyonlar" — sadece dışa açılan tel:/mailto:/site linkleri, ayrıca loglanmıyor. */
export function QuickActions({ phone, email, websiteUrl }: { phone: string | null; email: string | null; websiteUrl: string | null }) {
  return (
    <Card className="p-4">

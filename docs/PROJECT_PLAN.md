...
- [x] **`SourcesForm.tsx#TEMP_DEFAULT_SELECTION_CAP` geçici sınırı kaldırıldı** (2026-08-20) — Oturum 37'deki orijinal davranışa (sadece dil-varyantı hariç hepsi seçili) dönüldü. `docs/PROGRESS.md` Oturum 43/45.
